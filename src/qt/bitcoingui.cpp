                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Solaris Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Solaris address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Solaris Core"), this);
    aboutAction->setStatusTip(tr("Show information about Solaris Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Solaris"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Solaris addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Solaris addresses"));
    ...
    openAction->setStatusTip(tr("Open a Solaris: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Solaris Core help message to get a list with possible Solaris command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Solaris Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Solaris network", "", count));
}
...
{
    QString strTitle = tr("Solaris Core"); // default title
