                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Superbee Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Superbee address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and superbee: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Superbee Core"), this);
    aboutAction->setStatusTip(tr("Show information about Superbee Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Superbee"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Superbee addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Superbee addresses"));
    ...
    openAction->setStatusTip(tr("Open a Superbee: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Superbee Core help message to get a list with possible Superbee command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Superbee Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Superbee network", "", count));
}
...
{
    QString strTitle = tr("Superbee Core"); // default title
