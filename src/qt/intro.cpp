...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Superbee Core"),
     ...
     * override -datadir in the superbee.conf file in the default data directory
     * (to be consistent with superbeed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
