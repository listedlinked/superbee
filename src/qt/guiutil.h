...
/** Utility functions used by the Superbee Qt UI.
 */
namespace GUIUtil
{
...
// Render Superbee addresses in monospace font
...
// Parse "superbee:" URI into recipient object, return true on successful parsing
