                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Piv from zXLR"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXLR"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXLR));
