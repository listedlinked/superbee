...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Superbee Core superbee-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  superbee-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded superbee transaction") + "\n" +
                               "  superbee-tx [options] -create [commands]   " + _("Create hex-encoded superbee transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded superbee transaction
