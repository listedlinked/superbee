...
In order to support loading of multiple wallets in superbee-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is superbee.cpp.
...
Changes to superbee.cpp
----------------------
superbee.cpp is the entry point into superbee-qt, and as such, will require some minor modifications to provide hooks for
