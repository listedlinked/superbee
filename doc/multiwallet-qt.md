...
In order to support loading of multiple wallets in amsterdamcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is amsterdamcoin.cpp.
...
Changes to amsterdamcoin.cpp
----------------------
amsterdamcoin.cpp is the entry point into amsterdamcoin-qt, and as such, will require some minor modifications to provide hooks for
