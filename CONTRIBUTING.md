Contributing to Superbee Core
============================

The Superbee Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Superbee Core project, and is not to be
confused with overall Superbee Network Protocol consensus changes.

Whether a pull request is merged into Superbee Core rests with the project merge
...
Patches that change Superbee consensus rules are considerably more involved than
...
Where a patch set proposes to change the Superbee consensus, it must have been
...
The project leader is the release manager for each Superbee Core release.
