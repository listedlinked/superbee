...
The AmsterdamCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AmsterdamCoin Core project, and is not to be
confused with overall AmsterdamCoin Network Protocol consensus changes.

Whether a pull request is merged into AmsterdamCoin Core rests with the project merge
...
Patches that change AmsterdamCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AmsterdamCoin consensus, it must have been
...
The project leader is the release manager for each AmsterdamCoin Core release.
